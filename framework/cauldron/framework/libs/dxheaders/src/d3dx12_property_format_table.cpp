...
constexpr D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::FORMAT_DETAIL D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::s_FormatDetail[] = {
    ...
    {
        DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,    FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,           _TYPELESS,           _TYPELESS,      _TYPELESS,    TRUE, FALSE, FALSE, FALSE, FALSE, FALSE,        FALSE,
    },
    {
        DXGI_FORMAT_R32G32B32A32_TYPELESS,
        DXGI_FORMAT_R32G32B32A32_TYPELESS,
    ...
    // YUV 4:4:4 formats
    {
        DXGI_FORMAT_AYUV, DXGI_FORMAT_AYUV, D3DFCS_AYUV, {8, 8, 8, 8}, 32,   FALSE, 1,     1,    1,     D3DFL_STANDARD, D3DFTL_FULL_TYPE, B, G, R, A, _UNORM,
        _UNORM,           _UNORM,           _UNORM,      FALSE,        TRUE, FALSE, FALSE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_Y410,
        DXGI_FORMAT_Y410,
    ...
    // YUV 4:2:0 formats
    {
        DXGI_FORMAT_NV12, DXGI_FORMAT_NV12, D3DFCS_NV12, {0, 0, 0, 0}, 8,    FALSE, 2,    2,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, X, X, X, _UNORM,
        _TYPELESS,        _TYPELESS,        _TYPELESS,   FALSE,        TRUE, FALSE, TRUE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_P010, DXGI_FORMAT_P010, D3DFCS_P010, {0, 0, 0, 0}, 16,    FALSE, 2,    2,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, X, X, X, _UNORM,
        _TYPELESS,        _TYPELESS,        _TYPELESS,   FALSE,        FALSE, FALSE, TRUE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_P016, DXGI_FORMAT_P016, D3DFCS_P016, {0, 0, 0, 0}, 16,    FALSE, 2,    2,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, X, X, X, _UNORM,
        _TYPELESS,        _TYPELESS,        _TYPELESS,   FALSE,        FALSE, FALSE, TRUE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_420_OPAQUE,
    ...
    // YUV 4:2:2 formats
    {
        DXGI_FORMAT_YUY2, DXGI_FORMAT_YUY2, D3DFCS_YUY2, {0, 0, 0, 0}, 16,   FALSE, 2,     1,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, G, B, X, _UNORM,
        _UNORM,           _UNORM,           _TYPELESS,   FALSE,        TRUE, FALSE, FALSE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_Y210, DXGI_FORMAT_Y210, D3DFCS_Y210, {0, 0, 0, 0}, 32,    FALSE, 2,     1,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, G, B, X, _UNORM,
        _UNORM,           _UNORM,           _TYPELESS,   FALSE,        FALSE, FALSE, FALSE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_Y216, DXGI_FORMAT_Y216, D3DFCS_Y216, {0, 0, 0, 0}, 32,    FALSE, 2,     1,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, G, B, X, _UNORM,
        _UNORM,           _UNORM,           _TYPELESS,   FALSE,        FALSE, FALSE, FALSE, TRUE, FALSE, FALSE,
    },
    // YUV 4:1:1 formats
    {
        DXGI_FORMAT_NV11, DXGI_FORMAT_NV11, D3DFCS_NV11, {0, 0, 0, 0}, 8,    FALSE, 4,    1,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, X, X, X, _UNORM,
        _TYPELESS,        _TYPELESS,        _TYPELESS,   FALSE,        TRUE, FALSE, TRUE, TRUE, FALSE, FALSE,
    },
    // Legacy substream formats
    {
        DXGI_FORMAT_AI44, DXGI_FORMAT_AI44, D3DFCS_AI44, {0, 0, 0, 0}, 8,    FALSE, 1,     1,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, X, X, X, _UNORM,
        _TYPELESS,        _TYPELESS,        _TYPELESS,   FALSE,        TRUE, FALSE, FALSE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_IA44, DXGI_FORMAT_IA44, D3DFCS_IA44, {0, 0, 0, 0}, 8,    FALSE, 1,     1,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, X, X, X, _UNORM,
        _TYPELESS,        _TYPELESS,        _TYPELESS,   FALSE,        TRUE, FALSE, FALSE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_P8, DXGI_FORMAT_P8, D3DFCS_P8, {0, 0, 0, 0}, 8,    FALSE, 1,     1,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, X, X, X, _UNORM,
        _TYPELESS,      _TYPELESS,      _TYPELESS, FALSE,        TRUE, FALSE, FALSE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_A8P8, DXGI_FORMAT_A8P8, D3DFCS_A8P8, {0, 0, 0, 0}, 16,   FALSE, 1,     1,    1,     D3DFL_CUSTOM, D3DFTL_FULL_TYPE, R, X, X, X, _UNORM,
        _TYPELESS,        _TYPELESS,        _TYPELESS,   FALSE,        TRUE, FALSE, FALSE, TRUE, FALSE, FALSE,
    },
    {
        DXGI_FORMAT_B4G4R4A4_UNORM,
    ...
    {
        DXGI_FORMAT(116), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(117), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(118), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(119), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(120), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(121), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(122), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },

    {
        DXGI_FORMAT(123), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },

    {
        DXGI_FORMAT(124), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(125), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(126), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(127), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(128), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(129), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
    ...
    {
        DXGI_FORMAT(133), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(134), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(135), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(136), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(137), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(138), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(139), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(140), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(141), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(142), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(143), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(144), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(145), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(146), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(147), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(148), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(149), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(150), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(151), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(152), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(153), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(154), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(155), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(156), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(157), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(158), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(159), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(160), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(161), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(162), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(163), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(164), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(165), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(166), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(167), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(168), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(169), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(170), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(171), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(172), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(173), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(174), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(175), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(176), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(177), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(178), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(179), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(180), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(181), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(182), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(183), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(184), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(185), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(186), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(187), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
    {
        DXGI_FORMAT(188), DXGI_FORMAT_UNKNOWN, D3DFCS_UNKNOWN, {0, 0, 0, 0}, 0,     FALSE, 1,     1,     1,     D3DFL_CUSTOM, D3DFTL_NO_TYPE, X, X, X, X,
        _TYPELESS,        _TYPELESS,           _TYPELESS,      _TYPELESS,    FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,        TRUE,
    },
...
{
    if ((UINT)Format < std::size(s_FormatDetail))
    {
...
HRESULT D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::CalculateExtraPlanarRows(DXGI_FORMAT format, UINT plane0Height, _Out_ UINT& totalHeight)
{
    ...
    if (FAILED(Safe_UIntMult(plane0Height, extraHalfHeight, &extraPlaneHeight)) || FAILED(Safe_UIntAdd(extraPlaneHeight, round, &extraPlaneHeight)) ||
...
HRESULT D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::CalculateResourceSize(UINT                                              width,
                                                                  UINT                                              height,
                                                                  UINT                                              depth,
                                                                  DXGI_FORMAT                                       format,
                                                                  UINT                                              mipLevels,
...
UINT D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::GetBitsPerStencil(DXGI_FORMAT Format)
{
    ...
    if ((s_FormatDetail[Index].TypeLevel != D3DFTL_PARTIAL_TYPE) && (s_FormatDetail[Index].TypeLevel != D3DFTL_FULL_TYPE))
    {
        return 0;
    }
    for (UINT comp = 0; comp < 4; comp++)
    {
        ...
        {
        case 0:
            name = s_FormatDetail[Index].ComponentName0;
            break;
        case 1:
            name = s_FormatDetail[Index].ComponentName1;
            break;
        case 2:
            name = s_FormatDetail[Index].ComponentName2;
            break;
        case 3:
            name = s_FormatDetail[Index].ComponentName3;
            break;
        }
        if (name == D3DFCN_S)
        {
...
void D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::GetFormatReturnTypes(DXGI_FORMAT                          Format,
...
D3D_FORMAT_COMPONENT_NAME D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::GetComponentName(DXGI_FORMAT Format, UINT AbsoluteComponentIndex)
{
    ...
    {
    case 0:
        name = s_FormatDetail[GetDetailTableIndexNoThrow(Format)].ComponentName0;
        break;
    case 1:
        name = s_FormatDetail[GetDetailTableIndexNoThrow(Format)].ComponentName1;
        break;
    case 2:
        name = s_FormatDetail[GetDetailTableIndexNoThrow(Format)].ComponentName2;
        break;
    case 3:
        name = s_FormatDetail[GetDetailTableIndexNoThrow(Format)].ComponentName3;
        break;
    default:
        throw E_FAIL;
    }
...
D3D_FORMAT_COMPONENT_INTERPRETATION D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::GetFormatComponentInterpretation(DXGI_FORMAT Format, UINT AbsoluteComponentIndex)
{
    ...
    {
    case 0:
        interp = s_FormatDetail[GetDetailTableIndexNoThrow(Format)].ComponentInterpretation0;
        break;
    case 1:
        interp = s_FormatDetail[GetDetailTableIndexNoThrow(Format)].ComponentInterpretation1;
        break;
    case 2:
        interp = s_FormatDetail[GetDetailTableIndexNoThrow(Format)].ComponentInterpretation2;
        break;
    case 3:
        interp = s_FormatDetail[GetDetailTableIndexNoThrow(Format)].ComponentInterpretation3;
        break;
...
void D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::GetYCbCrChromaSubsampling(DXGI_FORMAT Format, _Out_ UINT& HorizontalSubsampling, _Out_ UINT& VerticalSubsampling)
{
    switch (Format)
    {
    // YCbCr 4:2:0
...
void D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::GetTileShape(D3D12_TILE_SHAPE* pTileShape, DXGI_FORMAT Format, D3D12_RESOURCE_DIMENSION Dimension, UINT SampleCount)
{
...
void D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::Get4KTileShape(D3D12_TILE_SHAPE* pTileShape, DXGI_FORMAT Format, D3D12_RESOURCE_DIMENSION Dimension, UINT SampleCount)
{
    UINT BPU = GetBitsPerUnit(Format);
...
UINT8 D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::GetPlaneSliceFromViewFormat(DXGI_FORMAT ResourceFormat, DXGI_FORMAT ViewFormat)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::GetPlaneSubsampledSizeAndFormatForCopyableLayout(UINT               PlaneSlice,
                                                                                          DXGI_FORMAT        Format,
                                                                                          UINT               Width,
                                                                                          UINT               Height,
...
bool D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::ValidCastToR32UAV(DXGI_FORMAT from, DXGI_FORMAT to)
{
    ...
    if (((to == DXGI_FORMAT_R32_UINT) || (to == DXGI_FORMAT_R32_SINT) || (to == DXGI_FORMAT_R32_FLOAT)) &&
        ((from == DXGI_FORMAT_R10G10B10A2_TYPELESS) || (from == DXGI_FORMAT_R8G8B8A8_TYPELESS) || (from == DXGI_FORMAT_B8G8R8A8_TYPELESS) ||
         (from == DXGI_FORMAT_B8G8R8X8_TYPELESS) || (from == DXGI_FORMAT_R16G16_TYPELESS) || (from == DXGI_FORMAT_R32_TYPELESS)))
    {
        return true;
    }
    return false;
...
bool D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::IsSupportedTextureDisplayableFormat(DXGI_FORMAT Format, bool bMediaFormatOnly)
{
    if (bMediaFormatOnly)
    {
        return (false || (Format == DXGI_FORMAT_NV12 || Format == DXGI_FORMAT_YUY2));
    }
    else
    {
        return (false  // eases evolution
                || (Format == DXGI_FORMAT_B8G8R8A8_UNORM || Format == DXGI_FORMAT_R8G8B8A8_UNORM || Format == DXGI_FORMAT_R16G16B16A16_FLOAT ||
                    Format == DXGI_FORMAT_R10G10B10A2_UNORM || Format == DXGI_FORMAT_NV12 || Format == DXGI_FORMAT_YUY2));
    }
}
...
bool D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::SNORMAndUNORMFormats(DXGI_FORMAT FormatA, DXGI_FORMAT FormatB)
{
    ...
    for (UINT c = 0; c < NumComponents; c++)
    {
        D3D_FORMAT_COMPONENT_INTERPRETATION fciA = GetFormatComponentInterpretation(FormatA, c);
        D3D_FORMAT_COMPONENT_INTERPRETATION fciB = GetFormatComponentInterpretation(FormatB, c);
        if (((fciA == D3DFCI_SNORM) && (fciB == D3DFCI_UNORM)) || ((fciB == D3DFCI_SNORM) && (fciA == D3DFCI_UNORM)))
        {
            return true;
        }
    }
...
bool D3D12_PROPERTY_LAYOUT_FORMAT_TABLE::DecodeHistogramAllowedForOutputFormatSupport(DXGI_FORMAT Format)
{
    return (
        ...
        /* YUV 4:4:4 */
        || Format == DXGI_FORMAT_AYUV || Format == DXGI_FORMAT_Y410 || Format == DXGI_FORMAT_Y416);
}
